...
public class DurationDialogFragment extends DialogFragment implements View.OnClickListener{
    ...
    private ScanSuccessPopupFragment.ResultDialogCallback dialogCallback;
    ...
    public void setDialogCallback(ScanSuccessPopupFragment.ResultDialogCallback dialogCallback) {
